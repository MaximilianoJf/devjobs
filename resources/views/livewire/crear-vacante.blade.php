...
<form class="md:w-1/2 space-y-5" wire:submit.prevent='crearVacante'>
    ...
    <div>
        ...
        <x-text-input 
        {{---en wire se utiliza wire:model para conectar directammente el front con el backend en vez de name---}}
            wire:model="titulo"
            id="titulo"
    ...
    <div>
        ...
        <x-text-input 
           ...
           accept="image/*"
        />
        {{--two way data binging (envias data al servidor e igual hay una respuesta al front) disponible por livewire para visualizar imagen--}}
        <div class="my-5 w-80">
            @if($imagen)
