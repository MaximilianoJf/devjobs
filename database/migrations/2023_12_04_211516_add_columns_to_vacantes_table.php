...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('vacantes', function (Blueprint $table) {
            $table->string('titulo');
            //Para que se relacione correctamente con la otra tabla, el atributo foraneo debe ser en singular por convenencia de laravel
    ...
    {
        Schema::table('vacantes', function (Blueprint $table) {
            //se puede pasar un arreglo para eliminar
